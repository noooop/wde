...
from wde.tasks.decode_only.modelzoo import DECODE_ONLY_MODELS
from wde.tasks.encode_only.modelzoo import ENCODE_ONLY_MODELS
from wde.tasks.reranker.modelzoo import RERANKER_MODELS
from wde.tasks.retriever.modelzoo import RETRIEVER_MODELS
