...
from wde.workflows.core.backends.quantization.qqq import \
...
def is_layer_skipped(prefix: str, ignored_backends: List[str]) -> bool:
    # prefix: model.backends.0.self_attn.q_proj
    # proj_name: q_proj
    ...
    if proj_name in FUSED_LAYER_NAME_MAPPING:
        ...
        for shard_prefix in shard_prefixes:
            is_shard_skipped = shard_prefix in ignored_backends
            ...
            if is_skipped is None:
                ...
                raise ValueError(
                    ...
                    "are quantized. All shards of fused backends "
                    "to have the same precision.")
    else:
        is_skipped = prefix in ignored_backends
