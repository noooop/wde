...
class AttnBackend:
    ...
    def get_backend_cls(backend):
        if backend == _Backend.FLASH_ATTN:
            ...
            from wde.workflows.prefill_only.backends.attention.backends.flash_attn import \
                PrefillOnlyFlashAttentionBackend  # noqa: E501
            return PrefillOnlyFlashAttentionBackend
        if backend == _Backend.XFORMERS:
            logger.info("Using XFormers backend.")
            from wde.workflows.prefill_only.backends.attention.backends.xformers import \
                PrefillOnlyXFormersBackend  # noqa: E501
            return PrefillOnlyXFormersBackend
        elif backend == _Backend.TORCH_SDPA:
            logger.info("Using Torch SDPA backend.")
            from wde.workflows.prefill_only.backends.attention.backends.torch_sdpa import \
            ...
            from wde.workflows.prefill_only.backends.attention.backends.flashinfer import \
            ...
            from wde.workflows.prefill_only.backends.attention.backends.torch_naive import \
